...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LinearLayout figure_btn;
    private LinearLayout light_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        figure_btn = (LinearLayout) findViewById(R.id.figure_btn);
    ...
    private void initListener(){
        ...
        figure_btn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.user_birth_input:
                showBirthDialog();
                break;
            case R.id.figure_btn:
                Intent intent = new Intent(MainActivity.this, figureCheck.class);
                startActivity(intent);
                break;
            case R.id.light_btn:

                Intent intent2 = new Intent(MainActivity.this, HciTest3Activity.class);
